...
`, Xa = yt.div`
    ...
    z-index: 99;
`;
function Ja({ handleCloseModal: e, message: r, overlayOpacity: n, modalBackground: i, modalColor: c }) {
  return /* @__PURE__ */ Rt.jsx(qa, { children: /* @__PURE__ */ Rt.jsx(Ga, { $opacity: n, children: /* @__PURE__ */ Rt.jsxs(Ha, { $background: i, children: [
    /* @__PURE__ */ Rt.jsx(Xa, { onClick: e, children: "X" }),
    r && /* @__PURE__ */ Rt.jsx(Ka, { $color: c, children: r })
  ] }) }) });
}
export {
  Ja as default
